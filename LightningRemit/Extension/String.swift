...
extension String {
    ...
    func extractPaymentInfo(spendableBalance: UInt64) -> (
        address: String, amount: String, payment: PaymentType
    ) {
        let queryParams = self.queryParameters()
    ...
    private func processBitcoinAddress(_ spendableBalance: UInt64) -> (String, String, PaymentType) {
    ...
    private func processLightningAddress(_ address: String) -> (String, String, PaymentType) {
